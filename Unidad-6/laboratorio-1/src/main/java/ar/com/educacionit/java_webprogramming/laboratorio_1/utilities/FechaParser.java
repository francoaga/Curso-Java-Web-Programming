...
public class FechaParser {
	...
	public static Date stringToDate(String fecha, String formatoFecha) {
		SimpleDateFormat formato = new SimpleDateFormat(formatoFecha);
		
		java.util.Date utilDate = null;
		try {
			utilDate = formato.parse(fecha);
	...
	public static String fechaToString(LocalDate fecha, String formatoFecha) {
		DateTimeFormatter formato = DateTimeFormatter.ofPattern(formatoFecha);
